...
<div class="row row-overflow">
    <div class="col-md-2">
        <div class="bs-sidebar">
            <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
                ...
                <?php
                foreach (eqLogic::byType('Neuronal') as $eqLogic) {
	...
	<div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
        <legend>{{Mes informations Neuron}}
        </legend>
        <?php
        if (count($eqLogics) == 0) {
            ...
            <fieldset>
				...
				<div class="form-group">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom du reseau de Neurone}}"/>
                    </div>
                </div>
				<div class="form-group">
